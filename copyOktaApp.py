...
orgName = "f5preprod.oktapreview.com"
apiKey = "000Nd-Bf_ksBhvCApVC6TkDUFO2GOXk_PIQIt78V5Y"
...
def ActiveApplications():


    getStagedUsersUrl = "https://"+orgName+".com/api/v1/apps?filter=status eq \"ACTIVE\""
